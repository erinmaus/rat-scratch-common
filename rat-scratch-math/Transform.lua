...
--- @return RatScratch.Math.Vector3, RatScratch.Math.Quaternion
function Transform.decomposeTransform(transform, translation, rotation)
...
--- @param transform love.Transform?
--- @return love.Transform
function Transform.makeOrthoTransform(
	left,
	right,
	bottom,
	top,
	...
	local m21, m22, m23, m24 =
		0, 2 / (top - bottom), 0, -(top + bottom) / (top - bottom)
	local m31, m32, m33, m34 =
...
--- @param transform love.Transform?
--- @return love.Transform
function Transform.makeFrustumTransform(
	left,
	right,
	bottom,
	top,
...
--- @param transform love.Transform?
--- @return love.Transform
function Transform.makePerspectiveTransform(
	fieldOfView,
	aspectRatio,
	near,
	far,

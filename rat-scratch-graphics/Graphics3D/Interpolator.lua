...
local function cubicSplineQuaternion(t, result, keyFrame1, keyFrame2)
	...
	result:from(
		c1 * keyFrame1.value.x
			+ c2 * keyFrame1.outTangent.x
			+ c3 * keyFrame2.value.x
			+ c4 * keyFrame2.inTangent.x,
		c1 * keyFrame1.value.y
			+ c2 * keyFrame1.outTangent.y
			+ c3 * keyFrame2.value.y
			+ c4 * keyFrame2.inTangent.y,
		c1 * keyFrame1.value.z
			+ c2 * keyFrame1.outTangent.z
			+ c3 * keyFrame2.value.z
			+ c4 * keyFrame2.inTangent.z,
		c1 * keyFrame1.value.w
			+ c2 * keyFrame1.outTangent.w
			+ c3 * keyFrame2.value.w
			+ c4 * keyFrame2.inTangent.w
	)
end
...
function Interpolator.linear(time, result, currentKeyFrame, afterKeyFrame)
	local delta = (time - currentKeyFrame.time)
		/ (afterKeyFrame.time - currentKeyFrame.time)
